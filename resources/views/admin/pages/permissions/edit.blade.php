        ...
        <div class="container-fluid mt-3">
            <div class="card card-flash">
                ...
                <div class="card-body scroll-y mx-5 mx-xl-15 my-7">
                    ...
                    <form class="form" action="{{ route('admin.permission.update', $permission->id) }}"
                        method="POST">
                        @csrf
                        @method('PATCH')

                        <div class="fv-row mb-7">
                            <x-admin.label for="goup-name" class="col-form-label fw-bold fs-6">{{ __('Group Name') }}
                            </x-admin.label>

                            <x-admin.input id="goup-name" type="text" name="group_name" :value="old('group_name', $permission->group_name)"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <x-admin.input id="permission-add-name" type="text" name="name" :value="old('name', $permission->name)"
