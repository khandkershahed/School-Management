<x-admin-app-layout :title="'Ledger Report'">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card border-0 shadow-none">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.report.daily-ledger') }}" method="GET" class="filter-form">
                                <div class="container-fluid">
                                    <div style="padding-left:35px;padding-right:35px;">
                                        ...
                                        <div class="row my-3 align-items-center justify-content-center">
                                            ...
                                            <div class="col-4 text-center">
                                                <a href="{{ route('admin.report.daily-ledger') }}"
                                                        ...
                                                        <tbody>
                                                            @foreach ($incomes as $income)
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center">{{ $income->fee_type }}</td>
